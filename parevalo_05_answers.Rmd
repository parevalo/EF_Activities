...
Three chains are used as rule of thumb in this case, and also because the example is rather trivial. For the same reason, no initial parameters are used. 5000 iterations are used to guarantee convergence without having to resample, and also because of the simplicity of the model, which won't have an impact on performance. 
